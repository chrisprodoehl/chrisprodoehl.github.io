...
var csound_extended_module = (function() {
  ...
  return (
function(csound_extended_module) {
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 6396864,
    DYNAMIC_BASE = 6396864,
    DYNAMICTOP_PTR = 1153952;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=1153808;


  var ___tm_timezone=(stringToUTF8("GMT", 1153856, 4), 1153856);function _gmtime_r(time, tmPtr) {
...
function jsCall_jjii(index,a1,a2,a3) {
    return functionPointers[index](a1,a2,a3);
}
...
function jsCall_vijjiii(index,a1,a2,a3,a4,a5,a6) {
    functionPointers[index](a1,a2,a3,a4,a5,a6);
}
...
var asmLibraryArg = {
  ...
  "jsCall_ffi": jsCall_ffi,
  "jsCall_fi": jsCall_fi,
  "jsCall_fif": jsCall_fif,
  ...
  "jsCall_iiiiiiiiiifii": jsCall_iiiiiiiiiifii,
  ...
  "_csp_barrier_alloc": _csp_barrier_alloc,
  "_csp_orc_sa_print_list": _csp_orc_sa_print_list,
  "_dag_build": _dag_build,
  "_dag_end_task": _dag_end_task,
  "_dag_get_task": _dag_get_task,
  "_dag_reinit": _dag_reinit,
